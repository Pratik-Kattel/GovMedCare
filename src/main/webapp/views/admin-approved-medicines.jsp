...
<html>
<head>
  <title>Monitor Medicine – GovMediCare</title>
    ...
    <div class="table-card">
      <c:choose>
        <c:when test="${empty medicines}">
          <div class="empty-state">No approved medicines found.</div>
        </c:when>
          ...
          <table>
            ...
            <c:forEach var="med" items="${medicines}" varStatus="loop">
              <tr>
                ...
                <td>
                  <form method="post"
                        action="${pageContext.request.contextPath}/admin/approved-medicines">
